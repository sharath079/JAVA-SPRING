...
public class UserDAOIMPL implements UserDAO {
	...
	public int insert(UserBO userbo) throws Exception {
		//System.out.println("ds class--->"+hkds.getClass());
		int count=0;
		...
		ps.setInt(1,userbo.getId());
		ps.setString(2,userbo.getName());
		ps.setString(3,userbo.getPassword());
		ps.setString(4,userbo.getGender());
		ps.setString(5,userbo.getNationality());
		ps.setString(6,userbo.getLicense());
		ps.setInt(7, userbo.getAuthority_id());
	...
	/*@Override
	public List<UserBO> findUserByName(String name) throws SQLException {
				...
				con=hkds.getConnection();
				//create PreparedStatement obj having SQL Query
				ps=con.prepareStatement(RETRIEVAL_USER);
				ps.setString(1, name);
				rs=ps.executeQuery();
